...
Consumer checkout uses Adyen Web Drop-in v6 — Apple Pay + Google Pay + hosted card. Never re-add raw card fields as the primary flow.
...
- [Payments architecture](mem://features/payments) — Adyen Drop-in v6, Apple/Google Pay, mock mode, domain-verification file
