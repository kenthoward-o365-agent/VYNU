...
## Core
Noshi: agentic dining platform (formerly Sippa). Australia-first. Replaces menus with AI intent.
...
- [Brand colors](mem://design/brand-colors) — Noshi brand: Ai indigo #1B3A5C, Kinpaku gold #C9A84C, Sumi #1A1A1A, Shiroi #F8F5ED
