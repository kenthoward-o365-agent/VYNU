...
const tocItems: TocItem[] = [
  ...
  { id: "sippa-ai-analytics", label: "Sippa AI Analytics", icon: BarChart3 },
    ...
    <div className="flex gap-6 max-w-7xl mx-auto relative">
      ...
      <div className="flex-1 space-y-8 min-w-0">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Everything you need to set up and run your venue on Sippa.</p>
        </div>
        ...
        <Section id="getting-started" title="Getting Started" icon={Rocket}>
          <SubSection title="Welcome to Sippa">
            <p>Sippa replaces traditional menus with an AI-powered ordering experience. Diners scan a QR code at their table, chat with your venue's AI assistant, and place orders — no app download required.</p>
          </SubSection>
          <SubSection title="First-Time Setup Checklist">
            <StepList steps={[
              ...
              "Customise your Sippa AI agent personality in Settings → Sippa AI.",
        ...
        {/* Sippa AI Analytics */}
        <Section id="sippa-ai-analytics" title="Sippa AI Analytics" icon={BarChart3}>
          <SubSection title="What the AI Tracks">
            <p>Sippa AI Analytics shows you how diners interact with your AI assistant:</p>
            <ul className="list-disc list-inside space-y-1 pl-1">
          ...
          <SubSection title="Reading the Insights">
            <p>A high conversion rate means your AI personality and menu descriptions are working well. If diners are chatting a lot but not ordering, consider simplifying your menu descriptions or adjusting the AI's tone in Settings → Sippa AI.</p>
          </SubSection>
        </Section>
        ...
        <Section id="menu-builder" title="Menu Builder" icon={UtensilsCrossed}>
          ...
          <SubSection title="AI Import">
            <p>Upload a photo or PDF of your existing menu. Sippa's AI will read it and create categories and items automatically. Review and adjust before saving.</p>
            <StepList steps={[
