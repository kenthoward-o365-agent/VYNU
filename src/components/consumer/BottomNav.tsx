...
const BottomNav = ({ active, onNavigate, cartCount = 0 }: BottomNavProps) => {
  const tabs = [
    { id: "feed" as const, icon: Utensils, label: "Menu" },
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-card/95 backdrop-blur-lg border-t border-border z-50">
