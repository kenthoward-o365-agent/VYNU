...
const competitors = ["VYNU", "me&u", "Mr Yum", "Chewzie", "Square / Toast"] as const;
    ...
    rows: [
      {
        ...
        values: { "VYNU": "tick", meu: "dash", "Mr Yum": "dash", Chewzie: "dash", "Square / Toast": "dash" },
        notes: {
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "limited", "Mr Yum": "limited", Chewzie: "limited", "Square / Toast": "limited" },
        notes: {
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "dash", "Mr Yum": "limited", Chewzie: "dash", "Square / Toast": "dash" },
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "tick", "Mr Yum": "tick", Chewzie: "tick", "Square / Toast": "tick" },
      },
      {
        ...
        values: { "VYNU": "tick", meu: "limited", "Mr Yum": "tick", Chewzie: "limited", "Square / Toast": "limited" },
    ...
    rows: [
      {
        ...
        values: { "VYNU": "tick", meu: "limited", "Mr Yum": "limited", Chewzie: "dash", "Square / Toast": "limited" },
        notes: {
    ...
    rows: [
      {
        ...
        values: { "VYNU": "tick", meu: "limited", "Mr Yum": "limited", Chewzie: "limited", "Square / Toast": "tick" },
        notes: {
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "limited", "Mr Yum": "dash", Chewzie: "limited", "Square / Toast": "limited" },
        notes: {
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "dash", "Mr Yum": "dash", Chewzie: "limited", "Square / Toast": "dash" },
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "tick", "Mr Yum": "tick", Chewzie: "limited", "Square / Toast": "dash" },
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "dash", "Mr Yum": "dash", Chewzie: "dash", "Square / Toast": "limited" },
    ...
    rows: [
      {
        ...
        values: { "VYNU": "tick", meu: "limited", "Mr Yum": "limited", Chewzie: "limited", "Square / Toast": "dash" },
        notes: {
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "tick", "Mr Yum": "tick", Chewzie: "tick", "Square / Toast": "limited" },
      ...
      },
      {
        ...
        values: { "VYNU": "tick", meu: "tick", "Mr Yum": "limited", Chewzie: "tick", "Square / Toast": "limited" },
          ...
          {competitors.map((comp) => (
            <div
              ...
              className={`p-4 font-semibold text-center ${
                comp === "VYNU" ? "text-primary bg-primary/5" : "text-muted-foreground"
              }`}
            >
              {comp}
            </div>
